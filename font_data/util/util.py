...
def get_args():
    ...
    storage_dir = "/mnt/d/train_data/font_data_mini_space/"
    os.makedirs(storage_dir, exist_ok=True)
    parser.add_argument("--storage_dir", type=posix_path_to_str, default=storage_dir)
    parser.add_argument("--tar_path", type=posix_path_to_str, default=f"{storage_dir}/font_data_mini_space.tar.gz")
    ...
    parser.add_argument("--word_count", type=int, default=50000)
